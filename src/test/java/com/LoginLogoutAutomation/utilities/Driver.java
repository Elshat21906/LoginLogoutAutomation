package com.LoginLogoutAutomation.utilities;
        ...
        if (driverPool.get() == null){     //if (driver==null){
            ...
            switch (browser){
                ...
                case "saucelab-chrome" :
                    try {
                        URL url = new URL("https://oauth-ismailsonmez93-021c2:8cdfa05e-f94c-4111-b71e-ddc2dc137044@ondemand.eu-central-1.saucelabs.com:443/wd/hub");
                        DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
                        desiredCapabilities.setBrowserName("chrome");
                        driverPool.set(new RemoteWebDriver(url,desiredCapabilities));
                        driverPool.get().manage().window().maximize();
                ...
                case "saucelab-firefox" :
                    ...
                    URL url = null;
                    try {
                        url = new URL("https://oauth-ismailsonmez93-021c2:8cdfa05e-f94c-4111-b71e-ddc2dc137044@ondemand.eu-central-1.saucelabs.com:443/wd/hub");
